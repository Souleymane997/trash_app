...
class AddCapteurDialog extends StatefulWidget {
  const AddCapteurDialog({super.key});


  @override
  State<AddCapteurDialog > createState() => _AddCapteurDialogState();
}

class _AddCapteurDialogState extends State<AddCapteurDialog> {
  ...
  _submit() async {
    ...
    bool res = await CapteurController().addCapteur(capteurController.text.trim()) ;
    ...
    if(res){
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Capteur Ajouté') , backgroundColor: vert(),),
      );
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Center(child: CustomText('Ajouter Capteur', color: vert(),fontWeight: FontWeight.w700,tex: 1.5,)),
              ...
              children: [
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: _inputDecoration("id du capteur"),
