...
class _AddServiceState extends State<AddService> {
  ...
  _submit(String idStructure) async {
    ...
    ServiceModel item = ServiceModel(service_id: 1, structure_id: idStructure, nom_service: nomOptionController.text, nbre: int.parse(nbreController.text) , tarif: int.parse(tarifController.text), description: descController.text) ;
