...
import 'package:trash_app/controllers/avis_controller.dart';
...
class FeedbackPage extends StatefulWidget {
  const FeedbackPage({super.key, required this.idStructure});
...
class _FeedbackPageState extends State<FeedbackPage> {
  ...
  submit() async{
    ...
    if(res){
      DInfo.toastSuccess("Avis envoyé") ;
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: (){
                      if(_avisController.text.isNotEmpty){
                        submit() ;
                      }
                      else{
                        DInfo.toastError('ajouter un commentaire svp') ;
                      }
                    },
